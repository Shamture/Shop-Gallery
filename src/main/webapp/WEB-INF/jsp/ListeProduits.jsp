...
<body>
        ...
        <div class="nav-collapse collapse pull-right">
          <ul class="nav">
            <li><a href="<c:url value="/" />">Accueil</a></li>
                        ...
                        <li  class="active"><a href="<c:url value="/Produits.xhtml" />">Chorum</a></li>
  ...
  <div class="menu-of-button">
		<c:forEach items="${requestScope.categs }" var="item">
		  <a href="<c:url value="/Produits.xhtml/${item.id}" />"><button class="btn"><c:out value="${item.nom }" /></button></a>
		</c:forEach>
	</div>  
        <ul class="gallery col-4">
        	<c:forEach items="${prods }" var="item" varStatus="count">
        		<li>
                <div class="preview">
                    
                    <img alt=" " src="<c:url value="/resources/images/produits/${item.id}.jpg"/>">
                    <div class="overlay">
                    </div>
                    <div class="links">
                ...
                <div id="modal-${count.index}" class="modal hide fade">
                    ...
                    <div class="modal-body">
                        <img src="<c:url value="/resources/images/produits/${item.id}.jpg"/>" alt=" " width="100%" style="max-height:400px">
                        <div class="info-section">
                          ...
                          <strong>info : </strong><c:out value="${item.info }" /><br/>
                          </p>
                          
                          <a href="<c:url value="/contact.xhtml?type=produit&id=${item.id }" />" target="_blank"><button class="btn btn-primary">Commander</button></a>
                        </div>
                    </div>
                </div>                 
              </li>
