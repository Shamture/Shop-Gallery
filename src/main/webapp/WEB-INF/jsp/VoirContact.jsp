...
<head>
  ...
  <title>repondre au contact</title>
...
<body>
  ...
  <section  class="container">
    <p class="voir-contact">
      <strong>Nom : </strong><c:out value="${cont.nom }" /> <br/>
      <strong>Prenom : </strong><c:out value="${cont.prenom }" /> <br/>
      <strong>Email : </strong><c:out value="${cont.email }" /> <br/>
      <c:if test="${cont.idTab>0 }">
        <strong>Tableau : </strong><c:out value="${tab.nom }" /> <br/> 
      </c:if>
      <c:if test="${cont.idProd>0 }">
        <strong>Produit : </strong><c:out value="${prod.nom }" /> <br/> 
      </c:if>
      <strong>Quantite : </strong><c:out value="${cont.quantite }" /> <br/>
    ...
    <form method="post" action="">
      ...
      <textarea rows="6" cols="25" name="reponse" class="form-control"></textarea>
      </div>
      <input type="text" name="email" value="${cont.email }" class="hidden" />
      <div class="form-group">
