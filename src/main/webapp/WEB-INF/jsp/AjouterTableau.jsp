...
<head>
  ...
  <title>Ajouter Tableau - Admin</title>
...
<body>
  ...
  <div class="col-md-6">
  	<c:if test="${requestScope.success==true }">
  	  <div class="alert alert-success">
 			 <strong>Tableau ajouté avec success !</strong> 
	  </div>
  	</c:if>
  ...
  <form:form method="post" action="" modelAttribute="newtab"  enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <form:input type="text" path="taille" class="form-control" placeHolder="Largeur x Longeur" required = "required"/>
        </div>
        <div class="form-group">
            <label>Prix (DT)*</label>
        ...
        <div class="form-group">
            ...
            <form:input type="text" path="couleur" class="form-control" placeHolder="Couleur"/>
        </div>
        ...
        <br/><br/>
        <div class="form-group">
        	<input type="submit" class="btn btn-success btn-lg" value="Ajouter Produit" />
        </div>
  	</form:form>
  </div>
  	</div>
